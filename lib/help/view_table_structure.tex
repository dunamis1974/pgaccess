\subsection{View and change table structure}
...
You can cluster an index fo the table, more information on \htmlref{cluster SQL command}{cluster}.

Through "Permissions" tab you can assign new permissions for the table or alter the existing ones. See also \htmlref{GRANT}{grant} and \htmlref{REVOKE}{revoke} SQL commands.
